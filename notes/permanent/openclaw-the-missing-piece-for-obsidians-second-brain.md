...
Edit: since writing this article I've switched to using GPT-5.4 Codex via my existing ChatGPT Plus subscription ($20 USD/month). I will admit that it's a bit of a downgrade from Opus, but it's good enough.
