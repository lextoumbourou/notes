...
**Sana** is an efficient text-to-image diffusion model from NVIDIA that can generate high-resolution images, up to 4096 × 4096, with a much smaller model and far less compute than comparable models.
