...
[Linear Regression](linear-regression.md), [Lasso](lasso.md) and [Variable Subset Selection](variable-subset-selection.md) are examples of coefficient estimation techniques.
