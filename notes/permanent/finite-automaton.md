...
* [Deterministic Finite Automaton](deterministric-finite-automaton.md) where one state has exactly one transition for each possible input.
* [Nondeterministic Finite Automaton](nondeterministric-finite-automaton.md) where there can be several possible transitions for a given state and input.
