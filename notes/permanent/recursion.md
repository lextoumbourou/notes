...
**Recursion** is a problem-solving method where a [Function](function.md) calls itself with a smaller instance of the problem. A [Base Case](base-case.md) is required to ensure the calls eventually terminate.
