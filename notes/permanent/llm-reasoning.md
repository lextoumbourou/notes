...
This helped popularise the [Test-Time Scaling](../../../permanent/test-time-scaling.md) paradigm, allowing the models to spend a configurable amount of computation when answering a question to improve the result. Though this idea predates o1 and includes approaches such as sampling multiple reasoning paths and selecting a consistent answer, as well as generating longer reasoning traces [@wangSelfConsistencyImprovesChain2022].
