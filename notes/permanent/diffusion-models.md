...
**Diffusion Models** also known as **Diffusion Probabilitistic Models** are a type of generative model that learn to generate data by reversing a gradual, noise-driven diffusion process, inspired by [Nonequilibrium Thermodynamics](nonequilibrium-thermodynamics.md).
