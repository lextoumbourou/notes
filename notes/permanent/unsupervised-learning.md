...
* [Dimensionality Reduction](dimensionality-reduction.md) - to reduce the number of variables under consideration, simplifying the data while retaining essential information.
