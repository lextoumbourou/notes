...
The most common version is [Levenshtein Distance](levenshtein-distance.md), which allows insertions, deletions and substitutions. [Damerau Levenshtein](damerau-levenshtein.md) distance also allows transpositions of adjacent characters.
