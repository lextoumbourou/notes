...
* It's a [Commutative Operation](commutative-operation.md): $A \cup B = B \cup A$
* It's an [Associativity Operation](associativity-operation.md): $A \cup (B \cup C) = (A \cup B) \cup C$
