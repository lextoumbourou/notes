...
It builds on [HiFi-GAN](hifigan.md), and replaces the usual activations with the [Snake Activation Function](snake-activation-function.md), which adds a [Periodic Inductive Biases](periodic-inductive-biases.md) that suits audio.
