...
* Dealing with outliers:
    * Cut off tail of data - lower 25% and upper 25%
    <img src="/_media/st095-statistics/q1-q3.png"></img>
...
* Standard deviation (lower-case sigma)
    * ```sqrt(variance)```
<img src="/_media/st095-statistics/std-dev.png"></img>
...
<img src="/_media/st095-statistics/std-dev-distribution.png"></img>
* Bessel's correction
...
<img src="/_media/st095-statistics/sample-std-dev.png"></img>
