...
* Dealing with outliers:
    * Cut off tail of data - lower 25% and upper 25%
    <img src="/_media/st095-statistics/q1_q3.png"></img>
...
* Boxplots (aka box-and-whisper plots)
    <img src="/_media/st095-statistics/boxplots.png"></img>
* Variance:
...
* Standard deviation (lower-case sigma)
    * ```sqrt(variance)```
<img src="/_media/st095-statistics/std_dev.png"></img>
...
<img src="/_media/st095-statistics/std_dev_distribution.png"></img>
* Bessel's correction
...
<img src="/_media/st095-statistics/sample_std_dev.png"></img>
