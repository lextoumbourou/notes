...
* [[Vector Magnitude]] (0:35-2:54)
    * A vector can be described in terms of its unit vectors. In this example, they're $\hat{i}$ and $\hat{j}$:
        $r = a\hat{i} + b\hat{i}$
    * From [[Pythagoras Theorem]], we can calculate the magnitude (size) of the vector as $\|r\| = \sqrt{a^2 + b^2}$
...
* Cosign rule from algebra ([[Law of Cosines]]):
...
* In the triangle above, we can use [[Vector Subtraction]] to find the vector of side c: $r-s$
...
* [[Scalar Projection]] (00:00-04:04)
    ...
    * That explains why the [[Dot Product]] is also called the "Projection Product".
* [[Vector Projection]] (04:04-05:52)
...
* [[Coordinate System]] (00:00 - 03:35)
    * Coordinate system is defined by 2 vectors called the [[Basis Vectors]]. In the image, they're $\hat{e}_1 = \begin{bmatrix} 1 \\ 0 \end{bmatrix}$ and $\hat{e}_2 = \begin{bmatrix} 0 \\ 1 \end{bmatrix}$.
...
* [[Changing Basis]] (03:36-10:32)
    * We can use the dot product to find the numbers for a [[Vector]] in a different space if you know the new basis vectors in terms of the original.
