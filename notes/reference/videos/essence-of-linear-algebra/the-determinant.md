...
For example, after this [Matrix Transformation](../../../permanent/matrix-transformation.md) $\begin{bmatrix}3 && 0 \\ 0 && 2\end{bmatrix}$, $\hat{i}$ is scaled by a factor of 3, and $\hat{j}$ is scaled by a factor of 2. The rectangular area goes from an area of 1 ( $1 \ \times \ 1$ ) to 6 ( $3 \ \times \ 2$ ), we say the linear transformation has scaled area by 6.
...
The amount that we stretch or squish space is called the Determine ([Matrix Determinate](../../../permanent/matrix-determinate.md)).
