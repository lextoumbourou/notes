...
* [Combination](../../../permanent/combination.md)
    ...
    * Example 6.24
        ...
        * Solution:
            * We can use the [Pigeonhole Principal](../../../permanent/pigeonhole-principal.md)
...
* [Permutation with Repetition](../../../permanent/permutation-with-repetition.md)
    ...
    * Theorem 6.13
        ...
        * Proof
            ...
            * By [Multiplication Principle](../../../permanent/multiplication-principle.md), if all items are distinct, there would be $(n_1!, n_2!, ... n_k!)N$ permutations:
