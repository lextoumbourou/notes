...
from util import predict_transform, load_classes, prep_image, write_results
...
# Create directory used to save the detections
...
if batch_size != 1:
    ...
    im_batches = [torch.cat((im_batches[
...
for i, batch in enumerate(im_batches):
    ...
    # Makes sure CUDA kernel is synchronised with the CPU.

    if CUDA:
        torch.cuda.synchronize()

# Ensure some predictions were made.
try:
    output
except NameError:
